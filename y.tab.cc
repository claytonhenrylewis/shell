...
{
       0,   192,   192,   195,   196,   197,   201,   209,   212,   219,
     223,   224,   228,   235,   236,   240,   243,   246,   259,   267,
     268,   272,   278,   283,   292,   299,   303,   310,   311,   315,
     319
};
#endif
...
{
  "$end", "error", "$undefined", "WORD", "SUB", "ENV", "NOTOKEN", "GREAT",
  "NEWLINE", "GREATGREAT", "PIPE", "AMPERSAND", "LESS", "GREATAMPERSAND",
  "GREATGREATAMPERSAND", "TWOGREAT", "EXIT", "SOURCE", "$accept", "goal",
  "commands", "command", "simple_command", "command_and_args",
  "argument_list", "argument", "command_word", "pipe_list",
  "iomodifier_opt", "iomodifier_list", "background_opt", YY_NULLPTR
};
#endif
...
{
       0,    -6,    -7,    -7,    -2,    10,    14,     4,    -7,    -7,
      -7,    -7,     5,    -7,    -7,    11,    -7,    -7,     6,    20,
      15,    -7,    -7,    -7,    -7,    -7,    -7,    22,    28,    -7,
      29,    30,    31,    32,    -7,    33,    -7,    -7,    -7,    -7,
      -7,    -7,    -7
};
...
{
       0,     0,    18,    10,     0,     0,     0,     0,     4,     6,
      20,    14,    28,    11,     7,     0,     1,     5,    12,     0,
      30,     8,    17,    15,    16,    13,    19,     0,     0,    29,
       0,     0,     0,     0,    27,     0,    22,    21,    26,    24,
      23,    25,     9
};
...
{
      -3,     1,    13,     2,    -2,     1,    14,     2,     3,    22,
      23,    24,     3,    15,    16,    19,     4,     5,    26,    21,
       4,     5,    27,     2,    28,    36,    29,    30,    31,    32,
      33,    37,    38,    39,    40,    41,     0,     0,     0,     0,
       0,    42,    17
};
...
{
       0,     1,     8,     3,     0,     1,     8,     3,     8,     3,
       4,     5,     8,     3,     0,    10,    16,    17,    19,     8,
      16,    17,     7,     3,     9,     3,    11,    12,    13,    14,
...
{
       0,     1,     3,     8,    16,    17,    19,    20,    21,    22,
      23,    26,    27,     8,     8,     3,     0,    21,    24,    10,
      29,     8,     3,     4,     5,    25,    23,     7,     9,    11,
      12,    13,    14,    15,    28,    30,     3,     3,     3,     3,
       3,     3,     8
};
...
#line 240 "shell.y" /* yacc.c:1646  */
    {
    Command::_currentSimpleCommand->subShell( (yyvsp[0].string_val) );
  }
...
#line 243 "shell.y" /* yacc.c:1646  */
    {
	Command::_currentSimpleCommand->insertEnv( (yyvsp[0].string_val) );
  }
...
#line 272 "shell.y" /* yacc.c:1646  */
    ...
    Command::_currentCommand.insertOutput( (yyvsp[0].string_val) );
    /*printf("   Yacc: append\n");*/
